                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Container(
                                    ...
                                    child: BuildPosts(
                                      onTap: () => Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (ctx) =>
                                            ...
                                            title:
                                                kinderGartenPosts[index].title,
                                            description:
                                                kinderGartenPosts[index]
                                                    .description,
                                            images:
                                                kinderGartenPosts[index].images,
                                            price:
                                                kinderGartenPosts[index].price,
                                            grade:
                                                kinderGartenPosts[index].grade,
                                            bookEdition:
                                                kinderGartenPosts[index]
                                                    .bookEdition,
                                            educationLevel:
                                            ...
                                            createdAt: kinderGartenPosts[index]
                                                .createdAt,
                                            postId:
                                                kinderGartenPosts[index].postId,
                                          ),
                                        ),
                                      ),
                                      imageHeight: 160.h,
                                      ...
                                      image: kinderGartenPosts[index].images[0],
                                      ...
                                      onTap: () => Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (ctx) =>
                                            ...
                                            educationLevel: primaryPosts[index]
                                                .educationLevel,
                                      ...
                                      onTap: () => Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (ctx) =>
                                            ...
                                            description: preparatoryPosts[index]
                                                .description,
                                            images:
                                                preparatoryPosts[index].images,
                                            price:
                                                preparatoryPosts[index].price,
                                            grade:
                                                preparatoryPosts[index].grade,
                                            bookEdition: preparatoryPosts[index]
                                                .bookEdition,
                                            educationLevel:
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Container(
                                    ...
                                    child: BuildPosts(
                                      ...
                                      cityLocation: secondaryPosts[index].city,
                                      numberOfWatcher:
                                            ...
                                            builder: (ctx) =>
                                                CategoryDetailsScreen(
                                                  ...
                                                  images: generalPosts[index]
                                                      .images,
                                                  price:
                                                      generalPosts[index].price,
                                                  grade:
                                                      generalPosts[index].grade,
                                                  bookEdition:
                                                      generalPosts[index]
                                                          .bookEdition,
                                                  educationLevel:
                                                  ...
                                                  numberOfBooks:
                                                      generalPosts[index]
                                                          .numberOfBooks,
                                                  semester: generalPosts[index]
                                                      .semester,
                                                  educationType:
                                                      generalPosts[index]
                                                          .educationType,
                                                  location: generalPosts[index]
                                                      .location,
                                                  createdAt: generalPosts[index]
                                                      .createdAt,
