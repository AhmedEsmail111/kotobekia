      ...
      bottomSheet: Container(
        ...
        child: Row(
          children: [
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Padding(
                    ...
                    child: Icon(SolarIconsOutline.gallery, color: ColorConstant.primaryColor, size: 24.w),
                  ),
            ...
            Transform.scale(
              scaleX: -1,
              child: Icon(SolarIconsOutline.plain2, size: 24.w, color: ColorConstant.primaryColor),
            ),
          ],
        ),
      ),
