...
import 'package:kotobekia/shared/component/user_row_in_message.dart';
      ...
      child: Scaffold(
          ...
          child: Row(
            children: [
              Expanded(
                child: TextFormField(
                  maxLines:
                      null, // Allow the TextFormField to have multiple lines
        ...
        body: Column(
          ...
          children: [
            ...
            BuildTextMessage(
                font: font, text: 'الكتاب مجاني ولا بفلوس', sender: true),
            SizedBox(
              height: 36.h,
            ),
            BuildTextMessage(
                font: font,
                text: 'مجاني تقدري تستلميه مني في اقرب محطة مترو ',
                sender: false),
          ],
        ),
      ),
